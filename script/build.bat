...
cl /I "%src_dir%\script\microsoft.web.webview2.1.0.1020.30\build\native\include" ^
	"%src_dir%\script\microsoft.web.webview2.1.0.1020.30\build\native\x64\WebView2Loader.dll.lib" ^
	/std:c++17 /EHsc "/Fo%build_dir%"\ ^
